...
from src.dataloaders.dataset_augment import pose_random_scale, pose_rotation, pose_flip, pose_resize_shortestedge_random, \
    pose_crop_random, pose_to_img
from src.dataloaders.dataset_prepare import CocoMetadata
from os.path import join
from pycocotools.coco import COCO

BASE = "/home/yash/ARdata/"
...
def _parse_function(imgId, is_train, anno=None):
    """
    :param imgId:
    :return:
    """
